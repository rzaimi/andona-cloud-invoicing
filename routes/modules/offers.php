...
// Expensive endpoints (PDF generation, mail dispatch) — throttled.
...
Route::prefix('offer-layouts')->name('offer-layouts.')->group(function () {
    ...
    // Preview routes render a full PDF — throttled.
    Route::middleware('throttle:30,1')->group(function () {
        Route::post('/preview-live', [OfferLayoutController::class, 'previewLive'])->name('preview-live');
