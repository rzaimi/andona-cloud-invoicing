                    ...
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-3">
                                <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Neue Rechnung erstellen</h1>
...
const SortableInvoiceRowContext = React.createContext<SortableRowCtx>({ listeners: undefined, setActivatorNodeRef: () => {} })

function SortableInvoiceRowHandle() {
    const { listeners, setActivatorNodeRef } = React.useContext(SortableInvoiceRowContext)
    return (
...
function SortableInvoiceRow({ id, children }: { id: string; children: React.ReactNode }) {
    ...
    return (
        <SortableInvoiceRowContext.Provider value={{ listeners: listeners as Record<string, unknown> | undefined, setActivatorNodeRef }}>
            <TableRow
                ref={setNodeRef}
        ...
        </SortableInvoiceRowContext.Provider>
    )
}
