        ...
        <div class="invoice-details">
            ...
            <div class="amount-section">
                ...
                <div class="amount-row total">
                    ...
                    <span class="amount-value">{{ number_format(($openAmount ?? $invoice->total) + ($delayInterest ?? 0) + ($inkassoFee ?? 0), 2, ',', '.') }} €</span>
                </div>
            </div>
        </div>
