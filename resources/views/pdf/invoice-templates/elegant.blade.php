...
<div class="container">
    ...
    <div style="text-align: right; font-size: {{ $bodyFontSize }}px; margin-bottom: 10px;">
        ...
        <div style="margin-bottom: 4px;"><strong>LIEFERDATUM:</strong> {{ \Carbon\Carbon::parse($invoice->issue_date)->format('d. F Y') }}</div>
    ...
    <div style="margin-bottom: 8px;">
        <div style="font-size: {{ $headingFontSize + 4 }}px; font-weight: 700; color: {{ $invoice->is_correction ? '#dc2626' : ($layoutSettings['colors']['primary'] ?? '#2563eb') }};">
