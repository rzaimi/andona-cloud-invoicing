...
class SendDailyReminders extends Command
{
    ...
    protected function sendMahnungEmail(Invoice $invoice, Company $company, int $level, float $fee)
    {
        ...
        $pdf = Pdf::loadView('pdf.invoice', [
            ...
            // SECURITY: same hardening as InvoiceController::pdf — no remote
            // fetch, local-file read, or PHP eval inside DomPDF.
    ...
    protected function sendOfferReminder(Offer $offer, Company $company)
    {
        ...
        $pdf = Pdf::loadView('pdf.offer', [
            ...
            'defaultFont' => 'DejaVu Sans',
            // SECURITY: see InvoiceController::pdf — hardened DomPDF config.
            'isRemoteEnabled' => false,
            'isHtml5ParserEnabled' => true,
            'enable-local-file-access' => false,
            'isPhpEnabled' => false,
