...
class CompanyWizardController extends Controller
{
    ...
    public function complete(Request $request)
    {
        ...
        try {
            ...
            $welcomeFailed = false;
            if ($createdUser && $sendWelcomeEmail) {
                // Mails a password-setup link — never the password itself.
                $welcomeFailed = ! app(UserWelcomeMailer::class)->send($createdUser, $company);
            }
