...
class InvoiceLayoutController extends Controller
{
    ...
    public function index()
    {
        ...
        // Legacy keys alias at render time; the picker only shows these three.
        $templates = [
            [
                'id' => 'minimal',
                'name' => 'Minimal',
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'settings.content.show_auftragsnummer' => 'required|boolean',
    ...
    public function preview(InvoiceLayout $invoiceLayout)
    {
        ...
        $sampleInvoice = (object) [
            ...
            'bauvorhaben' => 'Neubau Musterstraße 12',
            'vat_regime' => 'standard',
            'skonto_percent' => null,
            'skonto_days' => null,
            'skonto_amount' => null,
    ...
    public function previewLivePdf(Request $request)
    {
        ...
        $sampleInvoice = (object) [
            ...
            'is_correction' => false,
            'items' => collect([
                (object) ['id' => 'item-001', 'description' => 'SEO-Optimierung und Beratung', 'quantity' => 19, 'unit' => 'Std.', 'unit_price' => 102.00, 'tax_rate' => 0.19, 'total' => 1938.00, 'discount_type' => null, 'discount_value' => null, 'discount_amount' => 0],
                (object) ['id' => 'item-002', 'description' => 'E-Commerce Shop Entwicklung', 'quantity' => 1, 'unit' => 'Stk.', 'unit_price' => 7598.00, 'tax_rate' => 0.19, 'total' => 7598.00, 'discount_type' => null, 'discount_value' => null, 'discount_amount' => 0],
                (object) ['id' => 'item-003', 'description' => 'Datenbank-Design und -Optimierung', 'quantity' => 13, 'unit' => 'Std.', 'unit_price' => 105.00, 'tax_rate' => 0.19, 'total' => 1365.00, 'discount_type' => null, 'discount_value' => null, 'discount_amount' => 0],
                (object) ['id' => 'item-004', 'description' => 'Mobile App Entwicklung', 'quantity' => 1, 'unit' => 'Stk.', 'unit_price' => 5128.00, 'tax_rate' => 0.19, 'total' => 5128.00, 'discount_type' => null, 'discount_value' => null, 'discount_amount' => 0],
            ]),
        ];
